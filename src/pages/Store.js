        ...
        <div className="home-style">
                    ...
                    <div className="discount-wrapper">
                        ...
                        {isAuthenticated && (
                            <div className="discount-wishlist-cart">
                                <button
                                    onClick={() => addProductToWishlist('gta5')}
                                >
                                    {isProductInWishlist('gta5')
                                        ? 'Remove'
                                        : 'Add to wishlist'}
                                </button>
                                <button
                                    className="add-to-cart-button"
                                    onClick={() => addProductToCart('gta5')}
                                >
                                    <FontAwesomeIcon
                                        icon={
                                            isProductInCart('gta5')
                                                ? faCheckCircle
                                                : faCartArrowDown
                                        }
                                    />
                    ...
                    <div className="discount-wrapper">
                        ...
                        {isAuthenticated && (
                            <div className="discount-wishlist-cart">
                                <button
                                    onClick={() =>
                                        addProductToWishlist('eldenring')
                                    }
                                >
                                    {isProductInWishlist('eldenring')
                                        ? 'Remove'
                                        : 'Add to wishlist'}
                                </button>
                                <button
                                    className="add-to-cart-button"
                                    onClick={() =>
                                        addProductToCart('eldenring')
                                    }
                                >
                                    <FontAwesomeIcon
                                        icon={
                                            isProductInCart('eldenring')
                                                ? faCheckCircle
                                                : faCartArrowDown
                                        }
                                    />
                    ...
                    <div className="discount-wrapper">
                        ...
                        {isAuthenticated && (
                            <div className="discount-wishlist-cart">
                                <button
                                    onClick={() =>
                                        addProductToWishlist('fifa23')
                                    }
                                >
                                    {isProductInWishlist('fifa23')
                                        ? 'Remove'
                                        : 'Add to wishlist'}
                                </button>
                                <button
                                    className="add-to-cart-button"
                                    onClick={() => addProductToCart('fifa23')}
                                >
                                    <FontAwesomeIcon
                                        icon={
                                            isProductInCart('fifa23')
                                                ? faCheckCircle
                                                : faCartArrowDown
                                        }
                                    />
            ...
            <div className="browse-by-category">
                ...
                <div className="img-container">
                    ...
                    ></img>
                    <div className="centered-text">Strategy</div>
                </div>
                <div className="img-container">
                    <img
                        className="browse-picture"
                    ...
                    ></img>
                    <div className="centered-text">Survival</div>
                </div>
                <div className="img-container">
                    <img
                        className="browse-picture"
                    ...
                    ></img>
                    <div className="centered-text">Free to Play</div>
                </div>
                <div className="img-container">
                    <img
                        className="browse-picture"
                    ...
                    ></img>
                    <div className="centered-text">Racing</div>
                </div>
                <button className="arrow-font-awesome">
