...
export default function Wishlist() {
    ...
    const { productsInWishlist, addProductToWishlist,  isProductInWishlist, addProductToCart, isProductInCart} = useContext(ProductsContext);
        ...
        <>
            <div className="wishlist-products-container">
                {productsInWishlist.length > 0 ? (
                    ...
                    <p className="wish-cart-text-color">You don't have any game in your wishlist.</p>
                )}

                <div className="wishlist-products">
                    {productsInWishlist.map((key) => {
                        return (
                            <div>
